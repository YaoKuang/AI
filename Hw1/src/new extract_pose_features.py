...
DATASET_DIR = os.path.join(BASE_DIR, "dataset", "image", "TRAIN")   # 你的五類資料夾直接放在 dataset 底下
...
# ===== MediaPipe Pose =====
MODEL_PATH = r"C:\temp\mediapipe_models\pose_landmarker_lite.task"
...
def normalize_landmarks(landmarks):
    ...
    for lm in landmarks:
        ...
        z = lm.z / torso_size
        norm_points.append((x, y, z, lm.visibility))
...
def main():
    ...
    for label in CLASSES:
        ...
        for fname in os.listdir(class_dir):
            ...
            feat = extract_pose_features(img_path)
